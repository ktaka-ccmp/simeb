\section{TIlluminGaussian  Class Reference}
\label{TIlluminGaussian}\index{TIlluminGaussian@{TIllumin\-Gaussian}}
...
\epsfbox{class_tillumingaussian.eps}
\end{center}
\end{figure}
...
\index{TIlluminGaussian@{TIllumin\-Gaussian}!TIlluminGaussian@{TIllumin\-Gaussian}}
\index{TIlluminGaussian@{TIllumin\-Gaussian}!TIlluminGaussian@{TIllumin\-Gaussian}}
\subsection{\setlength{\rightskip}{0pt plus 5cm}TIllumin\-Gaussian::TIllumin\-Gaussian (void)}

\label{TIlluminGaussian_a1}
\index{TIlluminGaussian@{TIllumin\-Gaussian}!Parse@{Parse}}
\index{Parse@{Parse}!TIlluminGaussian@{TIllumin\-Gaussian}}
...
\index{TIlluminGaussian@{TIllumin\-Gaussian}!Randomize@{Randomize}}
\index{Randomize@{Randomize}!TIlluminGaussian@{TIllumin\-Gaussian}}
